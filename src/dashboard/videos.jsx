...
//                                 {officer._id.replace('_', ' ').toUpperCase()}
//                               </Typography>
//                               <Typography variant="body2" color="text.secondary">
//                                 Traffic Officer
//                               </Typography>
...
//                           <Box mt={2}>
//                             <Chip 
//                               label={`Rank ${stats.findIndex(s => s._id === officer._id) + 1}`}
//                               color="primary"
//                               variant="outlined"
//                               size="small"
//                               sx={{ mr: 1 }}
...
const VerifiedByStats = () => {
  ...
  const fetchStats = async () => {
    try {
      // const res = await axios.get('http://localhost:5000/api/violations/verified-by');
            const res = await axios.get('http://kaapaan-backend.onrender.com/api/violations/verified-by');
